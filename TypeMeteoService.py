...
page.insert_delimiter_text("@@Today weather :@@", 3, 17)
...
page.insert_line("-", 30)
page.insert_delimiter_text("@@Next 3 days prevision :@@", 3, 32)
...
print(page.beautiful_print())

test_string(str_to_print)
auto_typewriter = AutoTypewriter()
auto_typewriter.underline_delimiter_press_string(str_to_print)